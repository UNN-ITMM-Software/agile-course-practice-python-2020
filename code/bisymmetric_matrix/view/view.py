...
class GUIView(object):
    ...
    def __init__(self):
        ...
        self.combobox1 = ttk.Combobox(self.frame1, state="readonly", values=self.val)
    ...
    def set_weight_to_grid(self):
        ...
        self.combobox1.grid(row=0, column=2, columnspan=2, padx=5, pady=5)
    ...
    def bind_events(self):
        ...
        self.combobox1.bind('<<ComboboxSelected>>', self.matrix_size_choosed)
    ...
    def matrix_size_choosed(self, event):
        self.mvvm_bind()
        self.mvvm_back_bind()
    ...
    def mvvm_bind(self):
        self.view_model.set_matrix_size(self.val[self.combobox1.current()])
