...
class GuiView(Tk.Frame):
    ...
    def __init__(self):
        ...
        self.first_poly_label = Tk.Label(self, text="Enter the coefficients of the first polynomial (type int) using ','", fg='black',
        ...
        self.second_poly_label = Tk.Label(self, text="Enter the coefficients of the second polynomial (type int) using ','", fg='black',
                                   font="Arial 12", bg="light yellow")
