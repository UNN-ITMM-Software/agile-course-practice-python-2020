...
class MatrixTests(unittest.TestCase):
    ...
    def test_check_constructor_with_wrong_matrix(self):
        test_matrix = Matrix.make_from_list([[1, 1], [1]])

        self.assertTrue(test_matrix.cols == 2 and test_matrix.rows == 2)
        self.assertTrue(test_matrix.data_lines[0][0] ==
                        test_matrix.data_lines[0][1] ==
                        test_matrix.data_lines[0][1] == 1)

    def test_check_value_coll_and_row(self):
        test_matrix = Matrix.make_from_list([[1, 1], [1]])
