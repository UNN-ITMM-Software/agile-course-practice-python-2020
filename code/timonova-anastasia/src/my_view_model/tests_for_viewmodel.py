...
class TestForViewModeWithFakeLogging(unittest.TestCase):
    ...
    def test_start_logging(self):
        self.assertEqual(['\n\n##    Start logging...    ##'],
                         self.view_model.my_logger.get_last_message_from_logs_list(1))
    ...
    def test_set_answer(self):
        ...
        self.assertEqual(['Setting answer: 0'], self.view_model.my_logger.get_last_message_from_logs_list(1))
