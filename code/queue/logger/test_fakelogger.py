...
from queue.logger.fakelogger import FakeLogger as Logger
...
class TestLogger(unittest.TestCase):
    ...
    def test_can_log_several_messages(self):
        self.logger.log('Test')
        self.logger.log('Another one test')

        self.assertEqual(['Test', 'Another one test'], self.logger.get_log_messages())

    def test_can_get_last_log(self):
        self.logger.log('Test')
        self.logger.log('Another one test')

        self.assertEqual('Another one test', self.logger.get_last_message())
