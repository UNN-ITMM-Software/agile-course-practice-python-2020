...
class QueueView(tk.Frame):
    def __init__(self, master=None):
        ...
        self.pack()
        self.create_widgets()
        self.viewmodel = QueueViewmodel(Logger())
    ...
    def create_widgets(self):
        ...
        # Отображение журнала
        self.history = tk.Text(self, height=10)
        self.history.pack()
    ...
    def enqueue(self):
        ...
        self.history.delete(1.0, "end-1c")
        self.history.insert("end-1c", self.viewmodel.history)
