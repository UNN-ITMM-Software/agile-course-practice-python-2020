...
class GuiApk:
    ...
    def __init__(self):
        self.root = tk.Tk()
        self.root.title('Radix sort algo')
        ...
        self.input_array = tk.Entry(self.root, width=75)
        self.sort_btn = tk.Button(self.root, text="Click me to sort", bg='#6dcae8')
        self.sorted_array_label = tk.Label(self.root, text="Sorted array:")
        self.sorted_array = tk.Entry(self.root, width=75)
    ...
    def set_weight_to_grid(self):
        ...
        self.start_message.grid(row=0,
                                column=0,
                                stick='wens',
                                padx=5,
                                pady=5)
        self.input_array.grid(row=0,
                              column=1,
                              stick='wens',
                              padx=5,
                              pady=5)
        self.sort_btn.grid(row=1,
                           column=0,
                           stick='wens',
                           padx=5,
                           pady=5)
        self.sorted_array.grid(row=1,
                               column=1,
                               stick='wens',
                               padx=5,
                               pady=5)
