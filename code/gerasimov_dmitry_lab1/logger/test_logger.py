...
from gerasimov_dmitry_lab1.logger.fake_logger import FakeLogger as Logger
...
class TestLogger(unittest.TestCase):
    ...
    def test_can_log_several_messages(self):
        ...
        self.assertEqual(['Test', 'Test2'], self.logger.get_log_messages())

    def test_can_get_last_log(self):
        self.logger.log('Test')
        self.logger.log('Test2')

        self.assertEqual('Test2', self.logger.get_last_message())
