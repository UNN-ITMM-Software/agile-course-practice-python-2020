...
class Line:
    ...
    @classmethod
    def is_intersect(cls, line1, line2):
        ...
        """
        p11, p12 = (line1.point1, line1.point2)
        p21, p22 = (line2.point1, line2.point2)
        ...
        if is_float_eq(det, 0.0):  # line segments are parallel
            ...
            check_line1 = is_point_on_line(p11, line2) or is_point_on_line(p12, line2)
            check_line2 = is_point_on_line(p21, line1) or is_point_on_line(p22, line1)
